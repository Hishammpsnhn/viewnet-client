    ...
    <div className="w-full">
      <div className="grid grid-cols-2 gap-4 mb-4">
        <input 
          ...
          onChange={(e) => setEditedGenre({...editedGenre, name: e.target.value})}
        ...
        <div className="flex items-center">
          <input 
            ...
            onChange={(e) => setEditedGenre({...editedGenre, isActive: e.target.checked})}
            className="mr-2"
          />
          <span>Active</span>
        </div>
      ...
      <textarea 
        ...
        onChange={(e) => setEditedGenre({...editedGenre, description: e.target.value})}
