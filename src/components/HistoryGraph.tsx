...
const HistoryGraph = () => {
  // Sample data for daily watch hours
  const data = [
    { day: "Sun", hours: 5 },
    { day: "Mon", hours: 3 },
    { day: "Tue", hours: 6 },
  ...
  return (
    <div className="max-w-2xl w-full  rounded-lg shadow bg-primary p-4 md:p-6">
      ...
      <div className="mt-6">
        <div className="flex justify-between">
          {data.map((item,index) => (
            <div key={item.day} className="flex flex-col-reverse items-center h-44">
              <div
                className="bg-[#6976EB] rounded-sm mb-2"
                style={{
                  height: "100%",
                  width: "40px",
                }}
